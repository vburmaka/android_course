 ...
 */
package com.example.lesson15service
    ...
    override fun onCreate() {
        ...
        locationCallback = object : LocationCallback() {
            override fun onLocationResult(locationResult: LocationResult) {
                ...
                Log.d(TAG, "onLocationResult: broadcast sent ${currentLocation.toText()}")
...
//                if (serviceRunningInForeground) {
                if (true) {
                    ...
                    Log.d(TAG, "notification shown:  ${currentLocation.toText()}")
                }
            }
        }
    }
    ...
    companion object {
        private const val TAG = "ForegrOnlyLocationServ"
